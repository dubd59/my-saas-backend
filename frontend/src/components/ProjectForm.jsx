...
const ProjectForm = () => {
  ...
  return (
    <div style={{ border: '1px solid #ddd', padding: '20px', backgroundColor: '#fff', borderRadius: '5px', maxWidth: '500px', margin: 'auto' }}>
            <h2 style={{ color: '#38beba', marginBottom: '20px', textAlign:'center' }}>Create Project</h2>
            <form onSubmit={handleSubmit}>
                ...
                {submitSuccess && <div style={{ color: 'green', marginTop: '10px' }}>Project created successfully!</div>}
            </form>
        </div>
  );
};
